...
class MidtransPageState extends State<MidtransPage> {
  ...
  Future<void> _handleSuccessPayment() async {
    ...
    _navigateToHome('Pembayaran berhasil! Tiket Anda telah dikonfirmasi.', true);
  }
  ...
  Future<void> _handleFailedPayment() async {
    ...
    _navigateToHome('Pembayaran dibatalkan atau gagal. Silakan coba lagi.', false);
  }
  ...
  Future<void> _updatePaymentStatus(String status) async {
    try {
      ...
      Map<String, dynamic> paymentData = {
        ...
        'isPaid': status == 'success' || status == 'success' || status == 'capture',
